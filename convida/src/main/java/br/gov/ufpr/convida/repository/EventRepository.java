...
public interface EventRepository extends MongoRepository<Event, String>{
    ...
    @Query("{$and: [{'active': true}],[{$and: [{'dateStart':{$lt: ?1}}, {'dateStart':{$gte: ?0}}, {'dateEnd': {$lte: ?1}}]},{$or:[{'type':{$regex: ?2}},{'type': {$regex: ?3}},{'type': {$regex: ?4}},{'type': {$regex: ?5}},{'type': {$regex: ?6}},{'type': {$regex: ?7}}, {'type': {$regex: ?8}}, {'type': {$regex: ?9}}]}]}")
    ...
    @Query("{$and: [{'active': true}], [{$and: [{'dateStart':{$lte: ?0}}, {'dateEnd': {$gte: ?0}}]},{$or:[{'type':{$regex: ?1}},{'type': {$regex: ?2}},{'type': {$regex: ?3}},{'type': {$regex: ?4}},{'type': {$regex: ?5}},{'type': {$regex: ?6}}, {'type': {$regex: ?7}}, {'type': {$regex: ?8}}]}]}")
    List<Event> findTodayType(Date minDate, String text, String text1, String text2, String text3, String text4, String text5,String text6, String text7);
